...
(* OASIS_START *)
(* DO NOT EDIT (digest: 78e1731bcb2fe9b0d0fe772ae29e96ea) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("api-oasis", OCamlbuildDocPlugin.doc_build "src/")
       ];
     ...
     clean_doc =
       [
          ...
          ("api-oasis", OCamlbuildDocPlugin.doc_clean "src/")
       ];
     distclean = [];
     distclean_test =
       [
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("odn",
                               Some (OASISVersion.VGreaterEqual "0.0.3"))
                        ];
                      bs_build_tools =
                        [
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/oasis";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "‚z½\141{\014×\002]%Øš$š÷,";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
