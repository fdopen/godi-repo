...
(* OASIS_START *)
(* DO NOT EDIT (digest: e136b19f1b7dd8a52c0efae3d76db618) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["SubCommand"; "ArgExt"; "ArgCommon"; "Pager"];
                      lib_pack = false;
                      lib_internal_modules = ["CLIData"; "PluginsLoaded"];
                      lib_findlib_parent = Some "oasis";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "¶±«£pŽÚVLåX#lêWS";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
