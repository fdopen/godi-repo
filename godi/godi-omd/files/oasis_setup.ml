...
(* OASIS_START *)
(* DO NOT EDIT (digest: e63ee22607e826fd29eb80af50016214) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/pw374/omd.git";
                      src_repo_browser = Some "https://github.com/pw374/omd";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "´@æ\0171ÚY“Òý5RÀ~Ð¹";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
