...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe29b2d32b23a319d90a34ff02f1069e) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "omd"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "omd_main.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/ocaml/omd.git";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\000AWG\019d\136¡Ú˙\016o≈â\141r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
