(* OASIS_START *)
(* DO NOT EDIT (digest: 1d11379d350deed8a53f081af057c502) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/custom_printf";
          synopsis = "Extension for printf format strings.";
          description =
            Some
              [
                 OASISText.Para
                   "Extension for printf format strings.  It rewrite calls to printf-like functions when the format is prefixed with '!' to wrap special arguments with 'Module.to_string' conversions functions."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Custom_printf_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "custom_printf";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "pa_custom_printf";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Pa_custom_printf"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "custom_printf";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Vù›ôõ¹éÃ\129ÉÙ$J\153Òf";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
