...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0bff2fa63b3b0fee6624283af337d055) *)
(*
...
let setup_t =
  {
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://forge.ocamlcore.org/anonscm/darcs/ocaml-fileutils/ocaml-fileutils";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "í\030°4†∆˜@4£ÃÈ„ﬂÚ‚";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
