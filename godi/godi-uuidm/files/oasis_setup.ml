...
(* OASIS_START *)
(* DO NOT EDIT (digest: 72a3c4c7e7aefebee24f73023154e41e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = ["(c) 2008-2012 Daniel C. BÃ¼nzli"];
          maintainers = [];
          ...
          description =
            Some
              [
                 ...
                 OASISText.Para
                   "Uuidm is made of a single, independent, module and distributed under the BSD3 license."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "N¼†\018öšhYÐ¿!ÆÛX’†";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
