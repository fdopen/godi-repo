...
(* OASIS_START *)
(* DO NOT EDIT (digest: a0f56beb94d00f99ed76dc1380aba421) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = ["(c) 2007-2012 Daniel C. BÃ¼nzli"];
          maintainers = [];
          authors = ["Daniel BÃ¼nzli <daniel.buenzli at erratique.ch>"];
          homepage = Some "http://erratique.ch/software/xmlm";
            ...
            [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xmlm"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "xmltrip.ml"; });
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "Xmlm's documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "\"Xmlm's README and CHANGES files\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://erratique.ch/repos/xmlm.git";
                      src_repo_browser =
                        Some "http://erratique.ch/repos/xmlm";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "fK¼¸A¦?”\029†\023\011`\017Òƒ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
