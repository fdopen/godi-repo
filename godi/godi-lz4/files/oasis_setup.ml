...
(* OASIS_START *)
(* DO NOT EDIT (digest: 17e4d09033c717c7d9851d7fde858560) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Peter Zotov"];
          homepage = Some "https://github.com/whitequark/ocaml-lz4";
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "LZ4_bindgen.ml"});
               Library
                 ({
                     cs_name = "lz4";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "lz4_bindgen"
                        ];
                      bs_c_sources = ["LZ4_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-llz4"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_LZ4.ml"});
               Test
                 ({
                     cs_name = "lz4";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for OCaml-LZ4";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/whitequark/ocaml-lz4.git";
                      src_repo_browser =
                        Some "https://github.com/whitequark/ocaml-lz4";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "4ayâÍCÉj=ÜÓJÿ¬\001Ð";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
