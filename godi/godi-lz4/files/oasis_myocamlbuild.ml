(* OASIS_START *)
(* DO NOT EDIT (digest: 8d5c5017098064bb9848270d155e3d15) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("lz4", ["lib"], [])];
     lib_c = [("lz4", "lib", [])];
     flags =
       [
          ...
          (["oasis_library_lz4_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-llz4"])])
       ];
