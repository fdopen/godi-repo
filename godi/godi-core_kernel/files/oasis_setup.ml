(* OASIS_START *)
(* DO NOT EDIT (digest: 2d75931f99ae14f6ec7eb0af81c9085b) *)
(*
...
let setup_t =
  {
     ...
     test =
       [
          ("test_pool_caml_modify_check",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$pool_caml_modify_check", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/core_kernel";
          ...
          distclean_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$rm", ["lib/config.mlh"; "lib/config.h"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          files_ab = [];
          sections =
            [
               Flag
                 ({
                     cs_name = "caml_modify_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "Enable caml modify tests";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "ld_wrap_possible", true)
                        ]
                   });
               Library
                 ({
                     cs_name = "check_caml_modify";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "caml_modify_test", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                      ...
                      bs_c_sources = ["caml_modify_stub.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Caml_modify"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "core_kernel";
                      lib_findlib_name = Some "check_caml_modify";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "raise_without_backtrace";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "raise_without_backtrace";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("typerep_kernel", None);
                           FindlibPackage ("typerep_kernel.syntax", None);
                           FindlibPackage ("unix", None);
                           FindlibPackage ("variantslib", None);
                           FindlibPackage ("variantslib.syntax", None);
                           InternalLibrary "raise_without_backtrace"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources =
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "core_kernel";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "pool_caml_modify_check";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.EFlag "caml_modify_test"),
                             true)
                        ];
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "core_kernel";
                           InternalLibrary "check_caml_modify"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "pool_caml_modify_check.ml"
                   });
               Test
                 ({
                     cs_name = "test_pool_caml_modify_check";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "pool_caml_modify_check"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\153³†nÎø\029bÜþ\144\129\rí–Œ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
