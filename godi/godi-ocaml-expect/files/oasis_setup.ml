...
(* OASIS_START *)
(* DO NOT EDIT (digest: 719e8eb77355789621421dc79a43fcbd) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-expect", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-expect", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     package =
       {
          ...
          homepage = Some "http://forge.ocamlcore.org/projects/ocaml-expect/";
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["ExpectPcre"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "expect";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "qa.ml"});
               Test
                 ({
                     cs_name = "main";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/expect";
                      doc_title = "API reference for Expect";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/ocaml-expect";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "[R\000´òò/G9P«A\144‘\0312";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
