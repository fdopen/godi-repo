...
(* OASIS_START *)
(* DO NOT EDIT (digest: ff2a3271eb25eeffbf3e3f05dbe12c2a) *)
(*
...
let setup_t =
  {
     ...
     doc = [("APIDOC", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("APIDOC", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("pgocaml_lowlevel",
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["PGOCaml"; "PGOCaml_generic"; "PGOCaml_config"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "÷»ÍÕ\000\1572.ú\019ÆžûÎ\007§";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
