...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4182eace3fb7b5cab5ab39e5345b7754) *)
(*
     ...
     package =
       {
          ...
          alpha_features = ["ocamlbuild_more_args"; "disable_oasis_section"];
          beta_features = [];
          name = "bitmasks";
          version = "1.0.0";
          license =
          ...
          license_file = None;
          copyrights = ["(c) 2013-2014 MetaStack Solutions Ltd."];
          maintainers = ["David Allsopp <david.allsopp@metastack.com>"];
          authors = ["David Allsopp"];
          homepage = Some "http://foo.example.com";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                                  ...
                                  Some
                                    (("sed",
                                       [
                                          ...
                                          "-e";
                                          "\"s/<br>//g\"";
                                          "_build/api-bitmasks.docdir/BitMask*.html"
                                       ])))
                             ]
                        };
                      doc_build =
                      ...
                      doc_install_dir = "$htmldir/bitmasks";
                      doc_title = "API reference for BitMasks";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
          ...
          disable_oasis_section = ["INSTALL.txt"];
          schema_data = PropList.Data.create ();
          plugin_data = []
       };
     oasis_fn = Some "_oasis";
     oasis_version = "0.4.3";
     oasis_digest = Some "–up†yqNÁ#\022'$\031¤Ù*";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
