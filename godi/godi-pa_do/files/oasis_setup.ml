(* OASIS_START *)
(* DO NOT EDIT (digest: 4b45b9eba8c11a334c76546ca977b546) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["src/META.ab"; "pa_do.godiva.ab"];
          sections =
            [
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Macro"; "Delimited_overloading"; "Std"; "Monad"];
                      lib_pack = true;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_do_nums"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_do";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_infix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_do";
                      lib_findlib_name = Some "infix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Delimited Overloading";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "op_basic.ml"});
               Executable
                 ({
                     cs_name = "op_mix";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "op_mix.ml"});
               Executable
                 ({
                     cs_name = "op_concrete";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "op_concrete.ml"});
               Executable
                 ({
                     cs_name = "do_std";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "do_std.ml"});
               Executable
                 ({
                     cs_name = "do_concrete";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "do_concrete.ml"});
               Executable
                 ({
                     cs_name = "do_api";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "do_api.ml"});
               Executable
                 ({
                     cs_name = "test_macro";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_macro.ml"});
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_complex.ml"});
               Test
                 ({
                     cs_name = "op_basic";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ad_hoc_newton.ml"});
               Executable
                 ({
                     cs_name = "comp_diff";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "comp_diff.ml"});
               Executable
                 ({
                     cs_name = "pi_digits";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "pi_digits.ml"});
               Executable
                 ({
                     cs_name = "rk4";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "rk4.ml"});
               Executable
                 ({
                     cs_name = "newton_basin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "examples/";
                      bs_compiled_object = Byte;
                      bs_build_depends = [FindlibPackage ("graphics", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "newton_basin.ml"});
               Executable
                 ({
                     cs_name = "newton_basin_base";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "newton_basin_base.ml"
                   });
               Executable
                 ({
                     cs_name = "newton_cotes";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "newton_cotes.ml"});
               Executable
                 ({
                     cs_name = "add_vec";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "use.ml"});
               Executable
                 ({
                     cs_name = "comp_assit_proof";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/comp_assit_proof/";
                      bs_compiled_object = Byte;
                      bs_build_depends = [FindlibPackage ("num", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "contraction.ml"});
               Executable
                 ({
                     cs_name = "first_order_logic";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/first_order_logic/";
                      bs_compiled_object = Byte;
                      bs_build_depends = [FindlibPackage ("num", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ray.ml"});
               Executable
                 ({
                     cs_name = "ray_orig";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ray_orig.ml"});
               SrcRepo
                 ({
                     cs_name = "trunk";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "http://forge.ocamlcore.org/anonscm/git/pa-do/pa-do.git";
                      src_repo_browser =
                        Some
                          "http://forge.ocamlcore.org/scm/browser.php?group_id=40";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some ",F\025T2“AÀ\027«iÎO“£Ý";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
(* Needed to generate pa_do.godiva *)
let _ =
  BaseEnv.var_define "ocamlforge_file_no" (fun _ -> "444")
