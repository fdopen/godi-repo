...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f88c1d1637da4d3eecf961cdba01f0e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["syntax/common/id.ml.ab"; "lib/META.ab"];
          sections =
            [
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "pa_deriving_classes";
                      lib_findlib_name = Some "common";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "pa_deriving_std";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pa_deriving_std"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Deriving";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests", OASISExpr.EFlag "tc"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "tests/tc";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ìŸ©À÷ñ'√xB\bÂ÷ÿ\028/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
