...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbbb37c1c727e59647d33fb41c5ebaf4) *)
(*
...
let setup_t =
  {
     ...
     doc = [("re-api", OCamlbuildDocPlugin.doc_build "./lib")];
     ...
     clean_doc = [("re-api", OCamlbuildDocPlugin.doc_clean "./lib")];
     distclean = [];
     distclean_test =
       [
          ("re_match",
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ím¼m-•§3eá\003SÕ 5\143";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
