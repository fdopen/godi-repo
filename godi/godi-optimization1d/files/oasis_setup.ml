...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1338381bf0678434fdb2e1b43f5fa24e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "http://forge.ocamlcore.org/projects/optimization1d/";
          synopsis = "Find extrema of 1D functions.";
          description =
            Some
              [
                 OASISText.Para
                   "Collection of functions to seek the minimum and maximum of functions float -> float."
              ];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "optimization1d"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "max1D_test.ml"});
               Executable
                 ({
                     cs_name = "min1D_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "min1D_test.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Optimization1d";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "ssh://forge.ocamlcore.org//git/optimization1d/optimization1d.git";
                      src_repo_browser =
                        Some
                          "https://forge.ocamlcore.org/scm/browser.php?group_id=280";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ÒðÔ\025\007»øÏã8*\007ô”&'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
