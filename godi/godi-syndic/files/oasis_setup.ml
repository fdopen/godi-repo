...
(* OASIS_START *)
(* DO NOT EDIT (digest: 07f0922b3f2fe27f33049719feac14d7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/Cumulus/Syndic";
          ...
          files_ab = ["lib/syndic_conf.ml.ab"];
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("xmlm",
                               Some (OASISVersion.VGreaterEqual "1.2.0"));
                           FindlibPackage
                             ("uri", Some (OASISVersion.VGreaterEqual "1.9"));
                           FindlibPackage
                             ("calendar",
                               Some (OASISVersion.VGreaterEqual "2.03.2"))
                        ];
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Syndic_common"; "Syndic_conf"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "syndic"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Cumulus/Syndic.git";
                      src_repo_browser =
                        Some "https://github.com/Cumulus/Syndic";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_decisions.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "]Éöš\022Å=àk‰¨Œ’e„;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
(* Define the variable "homepage" so that FilesAB can use it. *)
let _ =
  let homepage () =
    match setup_t.BaseSetup.package.OASISTypes.homepage with
    | Some h -> h
    | None -> "" in
  BaseEnv.var_define "homepage" homepage
