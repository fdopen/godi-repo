...
(* OASIS_START *)
(* DO NOT EDIT (digest: 338adee21f3365188ff2ad5ea59b8588) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/qcheck";
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["QCheck_ounit"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "qcheck";
                      lib_findlib_name = Some "ounit";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "qcheck_ounit"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "OUnit and QCheck integration";
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/c-cube/qcheck";
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/qcheck/tree/master/src";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\to¤aùlIí\011Q&c\027ƒKy";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
