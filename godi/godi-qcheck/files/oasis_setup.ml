...
(* OASIS_START *)
(* DO NOT EDIT (digest: ed8e1b3f57d52cf7aeba46c2466aed0d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "QuickCheck inspired property-based testing for OCaml. Also contains Gabriel Scherer's random value generator library, https://github.com/gasche/random-generator"
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["QCheck"; "generator/Generator"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Ö»¼ÂE:,ÁÂÛ\001|ó@\157@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
