...
(* OASIS_START *)
(* DO NOT EDIT (digest: ff9e4b72c3cb4fe260e9733c0894b2c6) *)
(*
          ...
          description =
            Some
              [
                 ...
                 OASISText.Para
                   "Jsonm is made of a single module and depends on [Uutf][1]. It is distributed under the BSD3 license.";
                 OASISText.Para "[1]: http://erratique.ch/software/uutf"
              ];
          categories = [];
