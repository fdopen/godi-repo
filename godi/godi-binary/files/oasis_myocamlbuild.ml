(* OASIS_START *)
(* DO NOT EDIT (digest: f3c05f5430d4936821da8b78adcb819a) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_library_binary_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_binary_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_binary_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_binary_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_binary_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
