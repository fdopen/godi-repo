...
(* OASIS_START *)
(* DO NOT EDIT (digest: d948ad6203d738fd03219c74b241b928) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "This library uses `type_conv` to dump OCaml data structures using OCaml data notation.";
                 OASISText.Para
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "åabÞ÷õ\025{n\003ÔØKû‡[";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
