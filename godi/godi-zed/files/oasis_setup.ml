...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9dd697d83a62e6d66e325fd603fd3983) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/diml/zed.git";
                      src_repo_browser = Some "https://github.com/diml/zed";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Aß‹Åj¯9—\006rA;Û©Ö\b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
