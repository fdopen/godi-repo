...
(* OASIS_START *)
(* DO NOT EDIT (digest: da1919bb822940171dc0781163e7c8f2) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("zed-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("zed-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["J√©r√©mie Dimino"];
          homepage = Some "http://zed.forge.ocamlcore.org/";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("camomile",
                               Some (OASISVersion.VGreaterEqual "0.8"))
                        ];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Zed";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/zed";
                      src_repo_browser =
                        Some
                          "http://darcs.ocamlcore.org/cgi-bin/darcsweb.cgi?r=zed;a=summary";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "C˙®\021\015ú\030zã~Ó;”·UÕ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
