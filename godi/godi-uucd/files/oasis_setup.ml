...
(* OASIS_START *)
(* DO NOT EDIT (digest: a6a006d9c42d67774f59458348bb6440) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Uucd's documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "\"Uucd's README and CHANGES files\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://erratique.ch/repos/uucd.git";
                      src_repo_browser =
                        Some "http://erratique.ch/repos/uucd";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "Ó\025K»¨w≠R\016÷\021\"k›2Í";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
