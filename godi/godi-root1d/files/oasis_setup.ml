...
(* OASIS_START *)
(* DO NOT EDIT (digest: a712749907572c70290088257024af24) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://forge.ocamlcore.org/projects/root1d/";
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Whether the Benchmark findlib package is installed.";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "root1d"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "difficult.ml"});
               Executable
                 ({
                     cs_name = "speed";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "has_benchmark", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "tests";
                      bs_compiled_object = Best;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Root1d";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "ssh://forge.ocamlcore.org//git/root1d/root1d.git";
                      src_repo_browser =
                        Some
                          "http://forge.ocamlcore.org/scm/browser.php?group_id=281";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\153Ÿð3¬—Ò,¤\"j|\007\"d\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
