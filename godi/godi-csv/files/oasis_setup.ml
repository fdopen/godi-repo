...
(* OASIS_START *)
(* DO NOT EDIT (digest: 55c84ef56745279c23d48ffb68a43af4) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("write",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_write", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/Chris00/ocaml-csv";
          synopsis = "A pure OCaml library to read and write CSV files.";
          description =
            Some
              [
                 OASISText.Para
                   "This is a pure OCaml library to read and write CSV files, including all extensions used by Excel â\128” e.g. quotes, newlines, 8 bit characters in fields, \\\"0 etc.  A special representation of rows of CSV files with a header is provided.  The library comes with a handy command line tool called csvtool for handling CSV files from shell scripts."
              ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_header.ml"});
               Test
                 ({
                     cs_name = "header";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_write.ml"});
               Test
                 ({
                     cs_name = "write";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Chris00/ocaml-csv.git";
                      src_repo_browser =
                        Some "https://github.com/Chris00/ocaml-csv";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ÑœËZvJòÿ \031ÀÄ~rä=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
