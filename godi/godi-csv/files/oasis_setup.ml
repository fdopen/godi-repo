...
(* OASIS_START *)
(* DO NOT EDIT (digest: b21c2271b8e5e0e4595ae1ced12adb61) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "This is a pure OCaml library to read and write CSV files, including all extensions used by Excel â\128” e.g. quotes, newlines, 8 bit characters in fields, \\\"0 etc.  The library comes with a handy command line tool called csvtool for handling CSV files from shell scripts."
              ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¹ƒ%œ¤ùõqn¾#“óó…Ü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
