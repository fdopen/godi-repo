...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6da1d4ffbe8a90cc3b54b3a6b877a5af) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://rope.forge.ocamlcore.org/";
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Rope";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bench_rope.ml"});
               Executable
                 ({
                     cs_name = "bm_rope";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "bm_ropes.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://forge.ocamlcore.org/anonscm/git/rope/rope.git";
                      src_repo_browser =
                        Some
                          "https://forge.ocamlcore.org/scm/browser.php?group_id=101";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "×rtë|5\014\b,‡°\024\005XJ^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
