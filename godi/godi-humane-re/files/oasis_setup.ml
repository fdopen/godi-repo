...
(* OASIS_START *)
(* DO NOT EDIT (digest: c2f881191b571233eb0609d9a81b9a75) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_blog_post", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test1.ml"});
               Executable
                 ({
                     cs_name = "test_blog_post";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_blog_post.ml"});
               Test
                 ({
                     cs_name = "test_blog_post";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\006P ü@«jxgQµ\144ie~G";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
