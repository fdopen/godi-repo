(* OASIS_START *)
(* DO NOT EDIT (digest: 1b891243eecb69139d46d3595087ce83) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "typerep_lib";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "extended/lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "typerep_lib";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "typerep_extended";
                           FindlibPackage ("sexplib", None);
                           FindlibPackage ("sexplib.syntax", None)
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "«Ž\\Ï}®\020º¿%»B\129\129\029z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
