(* OASIS_START *)
(* DO NOT EDIT (digest: b2bcaa1d5065c6091b2537521cf8f17e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "typerep_kernel";
                      lib_findlib_name = Some "syntax";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typerep_core";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "typerep_kernel";
               ...
               Library
                 ({
                     cs_name = "typerep_generics_sexprep";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "generics/sexprep/lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "typerep_core";
                           FindlibPackage ("sexplib", None);
                           FindlibPackage ("sexplib.syntax", None)
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\011°£y?\129vg´\r\t\001Î.œû";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
