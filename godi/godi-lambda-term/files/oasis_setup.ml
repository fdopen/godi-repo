...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2efff591f9dfafe3fce3de5ffbeb249f) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("lambda-term-api", OCamlbuildDocPlugin.doc_build "./");
     ...
     clean_doc =
       [
          ("lambda-term-api", OCamlbuildDocPlugin.doc_clean "./");
          ("lambda-term-actions-man",
                 ...
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules =
                        ["LTerm_color_mappings"; "LTerm_resource_lexer"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "³]Dó\017¡ƒ\"oE \143sö_6";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
