...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8b0e2f493e320b2814ccbf2c854d5098) *)
(*
                   ...
                   [
                      (OASISExpr.EBool true,
                        ("$gzip",
                          [
                             "-c";
                             "man/lambda-term-actions.1";
                             ">";
                             "man/lambda-term-actions.1.gz"
                          ]))
                   ];
                 cmd_clean =
                   [
                      (OASISExpr.EBool true,
                        Some (("$rm", ["man/lambda-term-actions.1.gz"])))
                   ];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("lambda-term-inputrc-man",
            CustomPlugin.Doc.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$gzip",
                          [
                             ...
                             ">";
                             "man/lambda-term-inputrc.5.gz"
                          ]))
                   ];
                 cmd_clean =
                   [
                      (OASISExpr.EBool true,
                        Some (("$rm", ["man/lambda-term-inputrc.5.gz"])))
                   ];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("lamda-term-inputrc",
     ...
     package =
       {
          ...
          homepage = Some "http://lambda-term.forge.ocamlcore.org/";
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "2.4.0"));
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.react", None);
                           FindlibPackage
                             ("zed", Some (OASISVersion.VGreaterEqual "1.2"))
                        ];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "lambda-term";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "events.ml"});
               Executable
                 ({
                     cs_name = "colors";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "colors.ml"});
               Executable
                 ({
                     cs_name = "colors_256";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "colors_256.ml"});
               Executable
                 ({
                     cs_name = "rgb";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "rgb.ml"});
               Executable
                 ({
                     cs_name = "move";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "move.ml"});
               Executable
                 ({
                     cs_name = "hello";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "buttons.ml"});
               Executable
                 ({
                     cs_name = "checkbuttons";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "checkbuttons.ml"});
               Executable
                 ({
                     cs_name = "radiobuttons";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "radiobuttons.ml"});
               Executable
                 ({
                     cs_name = "shell";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "shell.ml"});
               Executable
                 ({
                     cs_name = "repl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "repl.ml"});
               Executable
                 ({
                     cs_name = "modal";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modal.ml"});
               Executable
                 ({
                     cs_name = "read-password";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "read_password.ml"});
               Executable
                 ({
                     cs_name = "read-yes-no";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "read_yes_no.ml"});
               Executable
                 ({
                     cs_name = "editor";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "editor.ml"});
               Executable
                 ({
                     cs_name = "lambda-term-actions";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "tools";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lambda-term"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "lambda_term_actions.ml"
                   });
               Executable
                 ({
                     cs_name = "history-stress-test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "history_stress_test.ml"
                   });
               Doc
                 ({
                     cs_name = "lambda-term-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "API reference for Lambda-Term";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               Doc
                 ({
                     cs_name = "lambda-term-actions-man";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      doc_type = (`Doc, "custom", Some "0.4");
                      doc_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)]
                      ...
                      doc_title = "Man page for lambda-term-actions";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files =
                        [("man/lambda-term-actions.1.gz", None)];
                      doc_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "gzip"]
                   });
               Doc
                 ({
                     cs_name = "lambda-term-inputrc-man";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "Man page for ~/.lambda-term-inputrc";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files =
                        [("man/lambda-term-inputrc.5.gz", None)];
                      doc_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "gzip"]
                   });
               Doc
                 ({
                     cs_name = "lamda-term-inputrc";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "lambda-term-inputrc example";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("lambda-term-inputrc", None)];
                      doc_build_tools = [ExternalTool "ocamlbuild"]
                   });
               Doc
                 ({
                     cs_name = "lambda-termrc";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "lambda-term resource file example";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("lambda-termrc", None)];
                      doc_build_tools = [ExternalTool "ocamlbuild"]
                   });
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/diml/lambda-term.git";
                      src_repo_browser =
                        Some "https://github.com/diml/lambda-term";
