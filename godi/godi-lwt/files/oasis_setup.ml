...
(* OASIS_START *)
(* DO NOT EDIT (digest: ff53e9e11c3ab2ae53fe25f935efd848) *)
(*
...
let setup_t =
  {
     ...
     doc = [("lwt-api", OCamlbuildDocPlugin.doc_build "./")];
     ...
     clean_doc = [("lwt-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test =
       [
          ("core",
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "½¶CÌV\020£åÅ2ÇßÈÐ\029n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
