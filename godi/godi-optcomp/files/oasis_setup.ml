...
(* OASIS_START *)
(* DO NOT EDIT (digest: e5516b99b085d1f68f5ac4ef081718c6) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("optcomp-api", OCamlbuildDocPlugin.doc_build "src")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("optcomp-api", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/optcomp";
                      src_repo_browser =
                        Some
                          "http://darcs.ocamlcore.org/cgi-bin/darcsweb.cgi?r=optcomp;a=summary";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "¬ý\006·jjýMV=î5 œÇÒ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
