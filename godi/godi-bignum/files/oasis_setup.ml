(* OASIS_START *)
(* DO NOT EDIT (digest: 7f4dd13443a41fdba40dd34f26d3ccf4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2009-2014 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/bignum";
          synopsis =
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bigint"; "Bignum0"; "Std"; "Zarith_1_3"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "bignum";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "x^4\143š†'îQÙét½h\0202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
