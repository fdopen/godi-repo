...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3118869143697b92532cdd7caad5a949) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("UnicodeVersion",
            NonePlugin.not_implemented "doc of section UnicodeVersion")
       ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "unftrip.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "uunf"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Uunf's documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title =
                        "\"Uunf's README, CHANGES and DEVEL files\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("README CHANGES DEVEL", None)];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://erratique.ch/repos/uunf.git";
                      src_repo_browser =
                        Some "http://erratique.ch/repos/uunf";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\006\b&t<\0147u…BŸ›Ú»EÃ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
