...
(* OASIS_START *)
(* DO NOT EDIT (digest: 48e05c54b78fb6b34ea5d082e4221105) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2007 mfp <mfp@acm.org>\n(C) 2007 bluestorm <bluestorm.dylc@gmail.com>"
            ];
          maintainers = [];
          authors =
            ["mfp <mfp@acm.org>"; "bluestorm <bluestorm.dylc@gmail.com>"];
          homepage = Some "https://bitbucket.org/cakeplus/pa_where";
          synopsis = "Backward declaration syntax for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Pa_where provides a syntax for backward declarations (allowing a top-to-bottom declarative style), using the \"where\" keyword. Local definitions in expressions and toplevel definitions are both supported."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_where"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "pa_where";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Hg;
                      src_repo_location =
                        "https://bitbucket.org/cakeplus/pa_where";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "U\018í°4°·Æ?ú¡\023_\001P¢";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
