...
(* OASIS_START *)
(* DO NOT EDIT (digest: b48331cbb19fe3cc8335b8eee7966873) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/mmottl/res";
          synopsis =
            ...
            [
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Hg;
                      src_repo_location = "ssh://hg@bitbucket.org/mmottl/res";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/res";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Ö\153l“j.\003hò7OÞ§©\022J";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
