...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0bd0cbeee225da594ae818213030fca2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://mmottl.github.io/res";
          synopsis =
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "res"];
                      bs_build_tools =
                        [ExternalTool "ocamldoc"; ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "buffer_ex.ml"});
               Executable
                 ({
                     cs_name = "defstrat";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "defstrat.ml"});
               Executable
                 ({
                     cs_name = "stupid_ga";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "stupid_ga.ml"});
               Executable
                 ({
                     cs_name = "weak_ex";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "weak_ex.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for RES";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/mmottl/res.git";
                      src_repo_browser = Some "https://github.com/mmottl/res";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ë\136?ZºÑ×±=ÙÐ/ö\016\001¹";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
