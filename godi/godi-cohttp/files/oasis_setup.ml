...
(* OASIS_START *)
(* DO NOT EDIT (digest: 068453bd6c8ba979393d2a65325b7e7f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Cohttp_lwt_body"; "Cohttp_lwt"; "String_io_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("conduit.async", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "3ò\017\030@ïÙ Ö÷ø¦\007w°î";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
