...
(* OASIS_START *)
(* DO NOT EDIT (digest: d53f626db71877410574647aaf224b53) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors =
            ["Christophe Troestler <Christophe.Troestler@umons.ac.be>"];
          homepage =
            Some "http://forge.ocamlcore.org/projects/integration1d/";
          synopsis = "Integration of functions of one variable.";
          description =
            Some
              "Collection of integration routines inspired by QUADPACK.\nPure OCaml code.";
          categories = ["http://science"];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Whether the gls findlib package is installed.";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "integration1d";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Integration1d";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "integration1d"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Svn;
                      src_repo_location =
                        "svn://scm.ocamlcore.org/svn/integration1d/trunk";
                      src_repo_browser =
                        Some
                          "http://forge.ocamlcore.org/scm/browser.php?group_id=285";
          ...
          plugins =
            [(`Extra, "META", Some "0.3"); (`Extra, "StdFiles", Some "0.2")];
     ...
     oasis_version = "0.4.3";
     oasis_digest = Some "|ªP¤YhÎKõçÓc\031Ì‡‡";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
