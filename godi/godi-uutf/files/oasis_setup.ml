...
(* OASIS_START *)
(* DO NOT EDIT (digest: 02be9a9192da7d5f67159934373056f6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://erratique.ch/software/uutf";
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "utftrip.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "uutf"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Uutf's documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "\"Uutf's README and CHANGES files\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://erratique.ch/repos/uutf.git";
                      src_repo_browser =
                        Some "http://erratique.ch/repos/uutf";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "ã^+‘\152!‹â×´K†Ý“5\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
