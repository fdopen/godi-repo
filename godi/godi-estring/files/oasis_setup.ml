...
(* OASIS_START *)
(* DO NOT EDIT (digest: 337a30858ad660520c7a0db3f2ecdfd4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Estring allows to transforms string literals in programs by prefixing them with a specifier. For example ``u\"foo\"'' can be autolatically replaced by ``Unicode.of_string \"foo\"''."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "q—÷gìâ\000í|2¼Åà›\018Š";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
