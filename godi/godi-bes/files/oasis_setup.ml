...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3ed7550ab79a67088df848e5607e11ce) *)
(*
...
let setup_t =
  {
     ...
     doc = [("doclib", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("doclib", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("qmc",
     ...
     package =
       {
          ...
          homepage = Some "https://forge.ocamlcore.org/projects/bes/";
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "frontend.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for bes library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "‡\tÕ„ÇBUP)t≠g\001QFú";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
