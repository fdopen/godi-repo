...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c72ea79620b77f43cce0e39bcff5ea3) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("utop-api", OCamlbuildDocPlugin.doc_build "./");
          ("utop-man",
     ...
     clean_doc =
       [
          ("utop-api", OCamlbuildDocPlugin.doc_clean "./");
          ("utop-man",
     ...
     package =
       {
          ...
          homepage = Some "http://utop.forge.ocamlcore.org/";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "2Æk‰ \012'\0072ƒ>\\\bQN\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
